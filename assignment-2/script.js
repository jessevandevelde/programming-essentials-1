...
function calculate() {
    ...
    const value1 = parseFloat(number1.value); // Add logic to retrieve the value from number1
    const value2 = parseFloat(number2.value); // Add logic to retrieve the value from number2
